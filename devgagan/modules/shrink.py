...
async def token_handler(client, message):
    ...
    if len(message.command) <= 1:
        ...
        join_button = InlineKeyboardButton("Join Channel", url="https://t.me/amanbots")
        premium = InlineKeyboardButton("Get Premium", url="https://t.me/amangodz")  # Callback for Help button
    ...
    if param:
        if user_id in Param and Param[user_id] == param:
            ...
            await message.reply("✅ You have been verified successfully! Enjoy your session for next 24 hours.")
            return
        else:
...
async def smart_handler(client, message):
    ...
    if await is_user_verified(user_id):
        ...
        await message.reply("Click the button below to verify your free access token: \n\n> What will you get ? \n1. No time bound upto 24 hours \n2. Batch command limit will be 40 \n3. All functions unlocked", reply_markup=button)
