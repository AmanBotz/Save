...
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/amangodz")],
        ]
    )
...
async def plan(client, message):
    plan_text = (
        "💰 **Premium Price**: Starting from 20 INR accepted via UPI (terms and conditions apply).\n"
        "📥 **Download Limit**: Users can download up to 1,000 files in a single batch command.\n"
