...
async def get_msg(userbot, sender, edit_id, msg_link, i, message):
    ...
    if 't.me/c/' in msg_link or 't.me/b/' in msg_link:
        ...
        if chat in saved_channel_ids:
            await app.edit_message_text(message.chat.id, edit_id, "Sorry! dude 😎 This channel is protected 🔐 by **__Aman Bots__**")
            return
        ...
        try:
            ...
            if file_size and file_size > size_limit and (freecheck == 1 and not verified):
                await edit.edit("**__❌ File size is greater than 2 GB, purchase tg premium to proceed__")
                return
